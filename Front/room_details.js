document.addEventListener("DOMContentLoaded", function() {
    ...
    if (employId) {
        ...
        fetch(`http://206.189.200.204:8080/api/v1/room/${employId}`)
            ...
            .then(empleado => {
              ...
              // Actualiza los elementos HTML con los detalles del producto
                ...
                document.getElementById("telef").value = empleado.roomCode;
                document.getElementById("direcc").value = empleado.maxPatient;
                document.getElementById("email1").value = empleado.description;
                document.getElementById("blood_emp").value = empleado.idBranch;
