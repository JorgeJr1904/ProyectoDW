document.addEventListener("DOMContentLoaded", function() {
    ...
    if (employId) {
        ...
        fetch(`http://206.189.200.204:8080/api/v1/patientHistory/${employId}`)
            ...
            .then(empleado => {
              ...
              // Actualiza los elementos HTML con los detalles del producto
                ...
                document.getElementById("telef").value = empleado.diagnosis;
                document.getElementById("direcc").value = empleado.weight;
                document.getElementById("email1").value = empleado.height;
                document.getElementById("blood_emp").value = empleado.description;
                document.getElementById("gen_emp").value = empleado.status;
                document.getElementById("idroom").value = empleado.idPatient;
...
//"2023-13-01", fecha json
      ...
      fetch(`http://206.189.200.204:8080/api/v1/patientHistory/update/${empid}`, {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json'
          },
...
fetch(`http://206.189.200.204:8080/api/v1/patientHistory/delete/${employ_del}`, {
method: 'DELETE',
headers: {
  'Content-Type': 'application/json'
}
...
function goto_list_exp(enlace) {
const dpi_pac = document.getElementById('idroom').value;
  
  window.location.href = './patient_history.html?id='+ dpi_pac;
}
