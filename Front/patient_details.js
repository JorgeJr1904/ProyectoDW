document.addEventListener("DOMContentLoaded", function() {
    ...
    if (employId) {
        ...
        fetch(`http://206.189.200.204:8080/api/v1/patient/${employId}`)
            ...
            .then(empleado => {
              ...
              // Actualiza los elementos HTML con los detalles del producto
                ...
                document.getElementById("idroom").value = empleado.roomId;
...
var boton = document.getElementById("history_exp");

// Asignar un evento de clic al botón
boton.addEventListener("click", function() {
  const id_paciente = document.getElementById("dpi_emp").value;
    // Redirigir a la página de Google
    window.location.href = './patient_history.html?id=' + id_paciente;
...
//"2023-13-01", fecha json
      ...
      fetch(`http://206.189.200.204:8080/api/v1/patient/update/${empid}`, {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json'
          },
...
fetch(`http://206.189.200.204:8080/api/v1/patient/delete/${employ_del}`, {
method: 'DELETE',
headers: {
  'Content-Type': 'application/json'
}
...
idroom.disabled = false;
idroom.style.backgroundColor = 'lightblue';
idroom.style.border = '2px solid red';
